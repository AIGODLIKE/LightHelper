data = {
    ...
    'Made light linking collections single-user for %d light(s)': '已将 %d 个灯光的链接集合设为单用户',
    ...
    "Light Linking Tool": "灯光链接工具",
    "Start Tool": "启动工具",
    "Stop Tool": "停止工具",
    "Activate Tool": "激活工具",
    "Activate Light Linking Tool": "激活灯光链接工具",
